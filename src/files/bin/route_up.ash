...
ip route add 127.0.0.0/8 dev lo table ${dev_number}
ip route add default via ${route_vpn_gateway} dev ${dev} table ${dev_number}
ip rule add from ${gateway_ip%?}0/24 table ${dev_number}
